...
新迁入苏黎世州的人员按上述流程完成首次住址申报后，还需要现场预约办理居留证的日期和时间，此项会在人口登记办公室的工作人员帮助下进行。预约完成后会获得预约单，须**凭预约单在规定的时间前往移民局办理居留证**（见[《首次办理居留证》](<../id_and_passport/first_id_application.md>)章节）。
