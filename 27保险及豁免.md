...
不可以，你应该等到你到达瑞士并申请了居委会的报到证（Meldebestätigung）之后再申请。然后，你居住地的主管部门会通知你医疗保险的义务。

如果你住在苏黎世市，当你在居委会登记居留证时，你会收到一封关于苏黎世强制医疗保险的信息函。请遵循信中的指示。请参考样本信:attachment[sample-letters.pdf]{src=".topwrite/assets/sample-letters.pdf" size="1.75 MB"}

如果你不是住在苏黎世市，程序因市镇的不同而不同。当你在居委会报到并申请居留证的时候，你也应该询问那里关于医疗保险的通常程序。
...
有的，有几家公司以合理的价格为国际学生提供VVG保险套餐。要了解更多信息，请访问[ETH国际学生健康保险网页](https://ethz.ch/de/studium/international/nach-ankunft/krankenversicherung/non-eu.html#par_textimage_1480546543)。如果你不确定，你可以联系[交流办公室](https://ethz.ch/de/studium/non-degree-angebote/austausch-und-gaststudium.html)（如果你是交流生）或[国际学生办公室](https://ethz.ch/de/studium/international.html)（如果你是本科生或硕士生）。
...
> 请等待。在处理豁免申请方面有很大的延迟——可能需要9个月的时间才会收到答复！请等待！如果你被居住地的市政府威胁要参加强制KVG保险，请联系我们。
>
...
每个日历年，医疗报销费用将首先计入免赔额（全自付）。累积超出免赔额后，将进入共付额（10%）阶段（保险公司报销90%）。受保人共付额支出累积达到700瑞郎后，之后的医疗费用才会由保险公司全报销。
...
> 关于共付额的官方法规条款：<https://www.bag.admin.ch/bag/en/home/versicherungen/krankenversicherung/krankenversicherung-versicherte-mit-wohnsitz-in-der-schweiz/praemien-kostenbeteiligung/kostenbeteiligung.html>
...
关于责任险（Liability）和房屋险（Household）的保险的说明请见：<https://forum.acssz.org/d/948>
...
对于责任险、房屋险以及口腔额外险，如你想进一步了解或咨询，可联系学联保险顾问伙伴JC Insurances的个人客户咨询服务Easyinsured：<https://easyinsured.ch/>
