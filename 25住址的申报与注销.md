...
>
> 3个人口登记处的联系电话均为：+41 44 412 15 15
...
> *报到证明：40瑞郎；居留卡制证：142瑞郎；以及其它可能费用。可刷卡（MasterCard、Visa卡可以，银联卡待核实），是否可现金待核实*
...
新迁入苏黎世的人员在按上述流程完成首次住址申报后，还需要现场预约办理居留证的日期和时间，此项会在人口登记处的工作人员帮助下进行。预约完成后会获得预约单，须凭预约单在规定的时间前往移民局办理居留证（见[28 居留卡办理](28移民局录指纹.md)）。
...
虽然相比于正式的居留证，这张确认使用频率相对较低，但是也应**妥善保管**（即使已获得正式居留证）。例如，[办理地址变更](https://www.stadt-zuerich.ch/prd/de/index/bevoelkerungsamt/umziehenmelden/umzug.html)时便需要用到这张报到确认函上的参考号（具体根据所选报告方式有所不同）。
...
根据苏黎世市法规，出租人（房东/中介/二房东）在房屋出租情况有变更时（即：原承租人搬出或有新的承租人搬入时等）需向社区所在的人口登记办公室报告房屋出租变动情况（[可在线完成](https://www.drittmeldung.ch/ui/#/home)）。与此同时，新承租人（包括转租租客）需要向社区所在的人口登记办公室。苏黎世市的有关政策可参见：[Stadt Zürich Drittmeldepflicht](https://www.stadt-zuerich.ch/prd/de/index/bevoelkerungsamt/umziehenmelden/drittmeldepflicht.html)
