...
根据苏黎世法律法规，出租人（房东/中介/二房东）在房屋出租情况有变更时（即：原承租人搬出或有新的承租人搬入时等）需向报告房屋出租情况变动。在实际操作中，这往往与**新承租人（包括转租租客）的地址申报**合并进行。苏黎世市的有关政策可参见：[Stadt Zürich Drittmeldepflicht](https://www.stadt-zuerich.ch/prd/de/index/bevoelkerungsamt/umziehenmelden/drittmeldepflicht.html)
