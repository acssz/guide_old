...
(关于本升硕之间的gap semester/year：如果本科不是ETH，官方是不允许注册semester leave的（这样不需要交学费）；但如果你只注册了学期而不注册任何课程和考试，那你事实上可以有gap year，只是要白交一个学期的学费。注意：两种选择都会算进program duration，请小心安排)
